    ...
    ngOnChanges(changes: any): void {
        if (
            ...
            (changes.selectedPalette &&
                changes.selectedPalette.currentValue === "")
        ) {
            this.removeColor();
            return;
        }
    ...
    updateSelectedColor(): void {
        setTimeout(() => {
            ...
            if (this.selectedPalette !== "" && this.selectedHue !== "") {
                this.selectedBg = MatColors.getColor(this.selectedPalette)[
                    this.selectedHue
                ];
                this.selectedFg = MatColors.getColor(
                    this.selectedPalette
                ).contrast[this.selectedHue];
                this.selectedClass =
                    "mat-" +
                    this.selectedPalette +
                    "-" +
