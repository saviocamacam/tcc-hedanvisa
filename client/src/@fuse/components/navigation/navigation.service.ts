...
export class FuseNavigationService {
    ...
    _onProfileOptionsChanged: BehaviorSubject<any>;
    ...
    constructor(public jwtHelper: JwtHelperService) {
        ...
        this._onProfileOptionsChanged = new BehaviorSubject(null);
    }
     ...
     * @returns {Observable<any>}
     */
    get onProfileOptionsChanged(): Observable<any> {
        return this._onProfileOptionsChanged.asObservable();
    }
    ...
    updateNavigationOptions() {
        console.log("updateNavigationOptions");
        const token = this.jwtHelper.decodeToken(localStorage.getItem("token"));
        if (token.user.profiles) {
            this._onProfileOptionsChanged.next(token.user.profiles);
        }
    }
